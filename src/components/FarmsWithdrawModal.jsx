...
export default function WithdrawModal( props) {
  ...
  const notify1 = () => toast.success(<div>{`Succesfully withdrawed ${Math.round(ValueOrder)+" " + tokens[props.index].name} !  `} <a href={`https://arbiscan.com/tx/${data?.hash}`} className="underline">arbiscan</a></div>)
  ...
  return (
    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      <div className='flex gap-2 '> <input
        ...
        /></div>
         <div className='text-base text-black'>Available { (selectedToken.name === "USDT"|| selectedToken.name === "USDC")? (ethers.utils.formatUnits(balance, 6) 
