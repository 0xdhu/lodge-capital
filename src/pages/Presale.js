...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="bg-[url('https://cdn.discordapp.com/attachments/943951700379721740/1075814264163541122/lodge-bg.png')] font-Montserrat   w-screen h-100%  bg-no-repeat bg-cover bg-center bg-fixed">
        <ExampleHeader /> <ExampleCA />
        <div className="  text-white md:grid grid-cols-12 grid-rows-6 gap-4 text-center">
          ...
          <div className="row-start-3 col-start-7   col-span-3 text-center font-semibold text-lg sm:text-xl mx-8  ">
            SOLD{" "}
            {(
              77317 +
          ...
          <div className=" row-start-3 col-start-4 col-span-3  row-span-2 text-center text-lg sm:text-xl  font-semibold  mx-8">
            {" "}
            SOLD{" "}
            {parseFloat(
              474.507 + ethers.utils.formatUnits(DuesSold, "ether") / 333
            ).toFixed(3)}{" "}
            DUES OUT OF 580.000
