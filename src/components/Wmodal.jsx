...
export default function WildCardModal() {
  ...
  return (
    <> {console.log(config)}{console.log(error)} <a
    type="button"
    onClick={handleOpen}
    className="bg-white/10 text-white hover:bg-white/20 focus-visible:outline-white mt-6 block rounded-md py-2 px-3 text-center text-sm leading-6 font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2  "
    >
     Mint
  </a>
    <Transition.Root show={open} as={Fragment}>
                ...
                src={
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      ...
                      <button
        type="button"
        className="inline-flex flex-auto justify-center items-center rounded-md border border-transparent bg-gradient-to-b from-blue-700 via-blue-800 to-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:from-gray-900 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2"
      onClick={handleClick}>
       BUSD
      </button><button
        type="button"
        className="inline-flex flex-auto items-center  justify-center rounded-md border border-transparent bg-gradient-to-b from-blue-700 via-blue-800 to-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:from-gray-900 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2"
      ...
      <div className='text-base text-gray-200'>Available {(selectedToken.name === "USDT"|| selectedToken.name === "USDC")? (Math.round(100*ethers.utils.formatUnits(balance, 6) 
