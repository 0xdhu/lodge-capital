        ...
        {({ open }) => (
          <>
            ...
            <Disclosure.Panel className="px-4 pt-4 flex mx-auto items-center bg-white max-w-7xl pb-2 text-sm text-black rounded-b-lg">
              ...
              <button
                disabled={ parseFloat(levelEarned) <= 0}
                onClick={() =>
                ...
                className={`bg-black mx-2 rounded-lg py-2 text-white flex-auto ${parseFloat(levelEarned) <= 0? "cursor-not-allowed": "cursor-pointer" }`}
              >
                Claim
              </button>
