...
import { updatePendingValueAtIndex, updatePoolTVLAtIndex } from "@/store/index";
...
const { chainId: arbChainId } = ContractAddressList;
...
const GenesisPool = ({
    ...
    // const { updatePendingValueAtIndex, updatePoolTVLAtIndex } = useContext(GenesisContext);
    ...
    const {refetch: tokenPendingRead} = useContractRead({
        ...
        onSuccess: (pendingData) => {
            ...
            if (pendingToken !== newPendingToken) {
                ...
                dispatch(updatePendingValueAtIndex({tokenIndex, pendingAmount: newPendingToken}));
            }
        }
    });
    ...
    useEffect(() => {
        ...
        dispatch(updatePoolTVLAtIndex({tokenIndex, poolTVL: pLockedValue}));
    }, [tokenTVL, tokenPrice])
